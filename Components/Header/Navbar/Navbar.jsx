                    ...
                    <div className="hidden md:flex md:justify-end w-full items-center" id="mobile-menu-2">
                        <ul className="flex space-x-8">
                            <li className='relative'>
                                <a href="#" className="text-white dark:text-white" aria-current="page">Portfolio</a>
                            ...
                            <li>
                                <a href="#" className="block text-white dark:text-white">Clientele</a>
                            </li>
                            <li>
                                <a href="#" className="block text-white dark:text-white">inquire</a>
                            </li>
                            <li>
